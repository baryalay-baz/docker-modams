(function () {
    ...
    window.PAMS_TOUR_REGISTRY["Assets/CreateAsset"] = {
        version: "v1",
        steps: [
            {
                element: '[data-tour="ca.category"]',
                popover: {
            ...
            {
                element: '[data-tour="ca.subcategory"]',
                popover: {
            ...
            {
                element: '[data-tour="ca.vehicleinfo"]',
                popover: {
            ...
            {
                element: '[data-tour="ca.specifications"]',
                popover: {
            ...
            {
                element: '[data-tour="ca.purchasedate"]',
                popover: {
            ...
            {
                element: '[data-tour="ca.receiptdate"]',
                popover: {
            ...
            {
                element: '[data-tour="ca.procuredby"]',
                popover: {
            ...
            {
                element: '[data-tour="ca.condition"]',
                popover: {
    ...
    const driverObj = driverFactory({
        animate: true,
        showProgress: true,
        steps: window.PAMS_TOUR_REGISTRY["Assets/CreateAsset"].steps,
